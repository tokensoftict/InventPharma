<div>
    ...
    <script>
        function printBarcode() {
            ...
            printWindow.document.write('.label-container { width: ' + width + '; height: ' + height + '; display: flex; flex-direction: column; justify-content: center; align-items: center; box-sizing: border-box; padding: 1mm 2mm; margin-top:2mm; overflow: hidden; position: relative; }');
