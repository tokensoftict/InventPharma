<div>
                    ...
                    <div class="card-body text-center"
                        ...
                        @if($selectedBarcode)
                            <div style="background: #fff; border: 1px solid #ddd; padding: 10px; display: inline-block;">
                                <div>{!! DNS1D::getBarcodeSVG($selectedBarcode, 'C128', 2, 70, 'black', false) !!}</div>
        ...
        <div id="barcode-print-area" style="display: none;"
            wire:key="print-area-{{ $numberOfCopies }}-{{ $selectedBarcode }}">@for($i = 0; $i < $numberOfCopies; $i++)
                <div class="label-container {{ $i < $numberOfCopies - 1 ? 'page-break' : '' }}"
                    ...
                    <div class="barcode-wrapper">{!! DNS1D::getBarcodeSVG($selectedBarcode, 'C128', 2, 70, 'black', false) !!}
    ...
    <script>
        function printBarcode() {
            ...
            printWindow.document.write('.label-container { width: ' + width + '; height: ' + height + '; display: flex; flex-direction: column; justify-content: center; align-items: center; box-sizing: border-box; padding: 1mm 2mm; margin-top:5mm; margin-left:2mm;  overflow: hidden; position: relative; }');
