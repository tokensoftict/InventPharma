<div>
    <div class="card">
        <div class="card-header bg-transparent border-bottom">
            <h4 class="card-title text-primary"><i class="bx bx-file me-1"></i> Supplier Cheque Valued Date Report</h4>
            <p class="card-title-desc">Filter, analyze, and manage supplier cheque payments by valued date.</p>
        </div>
        <div class="card-body">
            <div class="row mb-4 align-items-end">
                <div class="col-md-3">
                    <label class="form-label font-weight-bold">Filter By Valued Date</label>
                            ...
                            <h5 class="m-0">
                                <button class="btn btn-link w-100 text-start d-flex justify-content-between align-items-center text-decoration-none shadow-none" 
                                    ...
                                    <span class="font-size-15 text-dark fw-bold">
                                        <i class="bx bx-calendar-event me-2 text-primary font-size-18"></i>Valued Date: {{ $formattedDate }}
                                    </span>
                                        ...
                                        <tbody>
                                            @foreach($dayPayments as $row)
                                                @php
                                                    ...
                                                    $goingOutDate = $row->payment_info['going_out_date'] ?? '';
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <small class="text-muted d-block">Valued Date: <strong>{{ $goingOutDate }}</strong></small>
