@section('pageHeaderTitle', 'Manage Stocks for ' . $stockgroup->name)
@section('pageHeaderDescription', 'Add or remove stocks from this group')
...
<div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Stock to Group</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            @if($stock->stockgroup)
                                                Currently in: {{ $stock->stockgroup->name }}
                                            @else
                                                No Group
                                            @endif
                                        </small>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Stocks in {{ $stockgroup->name }}</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label">Search in Group</label>
                        <input type="text" wire:model.live.debounce.300ms="currentSearch" class="form-control" placeholder="Search stocks in this group...">
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">No stocks assigned to this group yet.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
