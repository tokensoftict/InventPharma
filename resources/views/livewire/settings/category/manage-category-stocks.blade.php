@section('pageHeaderTitle', 'Manage Stocks for ' . $category->name)
@section('pageHeaderDescription', 'Add or remove stocks for this category')

@section('pageHeaderAction')
    <a href="{{ route('category.index') }}" class="btn btn-secondary waves-effect waves-light">
...
<div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Stock to Category</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Stocks in {{ $category->name }}</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
