@section('pageHeaderTitle','Brand Manager')
@section('pageHeaderDescription','Manage All Brand Manager')

@section('pageHeaderAction')
    @if(userCanView('brand.create'))
        <div class="row">
            <div class="col-sm">
                <div class="mb-4">
                ...
                <table class="table">
                    ...
                    @foreach($this->get() as $manufacturer)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-primary btn-sm" href="{{ route('brand.stocks', $manufacturer->id) }}" title="View Stocks">
