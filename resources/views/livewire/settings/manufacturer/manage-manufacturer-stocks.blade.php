@section('pageHeaderTitle', 'Manage Stocks for ' . $manufacturer->name)
@section('pageHeaderDescription', 'Add or remove stocks for this manufacturer')

@section('pageHeaderAction')
    <a href="{{ route('manufacturer.index') }}" class="btn btn-secondary waves-effect waves-light">
        <i class="bx bx-arrow-back me-1"></i> Back to Manufacturers
    </a>
@endsection
...
<div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Stock to Manufacturer</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Stocks by {{ $manufacturer->name }}</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
