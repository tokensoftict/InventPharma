@section('pageHeaderTitle', 'Manage Stocks for ' . $classification->name)
@section('pageHeaderDescription', 'Add or remove stocks for this classification')

@section('pageHeaderAction')
    <a href="{{ route('classification.index') }}" class="btn btn-secondary waves-effect waves-light">
        <i class="bx bx-arrow-back me-1"></i> Back to Classifications
    </a>
@endsection
...
<div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Stock to Classification</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted">
                                            @if($stock->classification)
                                                Class: {{ $stock->classification->name }}
                                            @else
                                                No Classification
                                            @endif
                                        </small>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Stocks in {{ $classification->name }}</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
