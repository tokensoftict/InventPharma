...
class SendOrderUpdateToServerByInvoiceId extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:send-order-update-to-server-by-invoice';
    ...
    {
        $invoice_number = [2233405357,8835814587,9440606349,9691236683,3407067265,829447621,6625615648,9875266113];
